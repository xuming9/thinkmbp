var Layout = function () {
    var e = "layouts/layout3/img/", n = "layouts/layout3/css/", o = App.getResponsiveBreakpoint("md"), t = function () {
        ...
        var t = encodeURI(location.hash).toLowerCase(), a = $(".hor-menu");
        ...
        $(".page-header-menu");
        e >= o ? $(".page-header-menu").css("display", "block") : o > e && $(".page-header-menu").css("display", "none")
    }, r = function () {
        return
    }, p = function () {
        var e = 100, n = 500;
        navigator.userAgent.match(/iPhone|iPad|iPod/i) ? $(window).bind("touchend touchcancel touchleave", function (o) {
            ...
            return e.preventDefault(), $("html, body").animate({scrollTop: 0}, n), !1
        })
    };
    return {
